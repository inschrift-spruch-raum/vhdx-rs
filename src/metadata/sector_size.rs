...
pub const LOGICAL_SECTOR_SIZE_GUID: crate::common::guid::Guid = crate::common::guid::Guid([
...
pub const PHYSICAL_SECTOR_SIZE_GUID: crate::common::guid::Guid = crate::common::guid::Guid([
